...
import { encodeBase64, decodeBase64, isBase64, fileToBase64 } from "@/lib/tools/base64";
  ...
  return (
    <ToolLayout
      ...
      faqs={[
        ...
        { q: "Can I encode images to Base64?", a: "Yes. Drag and drop an image file onto the input area. The tool will generate a Base64 data URL that you can embed directly in HTML or CSS." },
        { q: "How do I decode a Base64 string?", a: "Switch to Decode mode and paste your Base64 string. The tool auto-detects if the input looks like Base64 and suggests decode mode." },
      ]}
      relatedTools={[
    ...
    >
      <div className="flex flex-wrap gap-3 mb-4">
        ...
        {autoDetected && mode === "encode" && (
          <span className="text-xs font-mono text-accent px-2 py-1 rounded-full bg-accent/10">Looks like Base64 — try Decode?</span>
        )}
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4" onDragOver={e => e.preventDefault()} onDrop={handleFileDrop}>
