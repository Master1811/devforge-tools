...
export default function GlassmorphismPage() {
  return (
    <>
      ...
      {/*
        BackgroundPaths is perfect for coming-soon / empty-state pages:
        • Fills the visual void without adding content clutter
        • The animated lines contextually echo what the tool will do
          (visual CSS → visual background)
        • Makes "coming soon" feel intentional and premium, not abandoned
      */}
      <main className="relative pt-24 pb-20 min-h-screen overflow-hidden">
        ...
        <div className="relative z-[1] max-w-2xl mx-auto px-6 text-center">
          <nav className="text-[11px] font-mono text-[rgba(10,10,10,0.40)] mb-10 flex items-center justify-center gap-2">
            ...
            <span className="text-[rgba(10,10,10,0.65)]">Glassmorphism Playground</span>
          </nav>
          ...
          <p className="text-[15px] text-[rgba(10,10,10,0.55)] leading-relaxed mb-8">
            Design glassmorphism UI components in real time. Tune blur, opacity, borders, and
            gradients with live CSS export. What you drag is exactly what you ship.
          </p>
